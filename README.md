...
I am a **learner** actively practicing Oracle SQL using curated LeetCode problems.  
...
| Phase | Topic | Level |
|-------|-------|-------|
| Phase 1 | SQL Basics (SELECT, JOIN, WHERE) | Beginner |
| Phase 2 | Aggregations & Window Functions | Intermediate |
| Phase 3 | Advanced / Complex SQL | Advanced |
| Phase 4 | Hard / Recursive & Interview SQL | Expert |
